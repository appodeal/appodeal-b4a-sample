...
public static String  _handler_bannerclicked() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub Handler_BannerClicked()";
 //BA.debugLineNum = 194;BA.debugLine="Log(\"banner clicked\")";
...
public static String  _handler_bannerfailedtoload() throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Sub Handler_BannerFailedToLoad()";
 //BA.debugLineNum = 186;BA.debugLine="Log(\"banner failed to load\")";
...
public static String  _handler_bannerloaded() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub Handler_BannerLoaded()";
 //BA.debugLineNum = 182;BA.debugLine="Log(\"banner loaded\")";
anywheresoftware.b4a.keywords.Common.Log("banner loaded");
 //BA.debugLineNum = 183;BA.debugLine="End Sub";
return "";
}
public static String  _handler_bannershown() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Sub Handler_BannerShown()";
 //BA.debugLineNum = 190;BA.debugLine="Log(\"banner shown\")";
...
public static String  _handler_interstitialclicked() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub Handler_InterstitialClicked()";
 //BA.debugLineNum = 173;BA.debugLine="Log(\"interstitial clicked\")";
...
public static String  _handler_interstitialclosed() throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Sub Handler_InterstitialClosed()";
 //BA.debugLineNum = 177;BA.debugLine="Log(\"interstitial closed\")";
...
public static String  _handler_interstitialfailedtoload() throws Exception{
 //BA.debugLineNum = 164;BA.debugLine="Sub Handler_InterstitialFailedToLoad()";
 //BA.debugLineNum = 165;BA.debugLine="Log(\"interstitial failed to load\")";
...
public static String  _handler_interstitialloaded() throws Exception{
 //BA.debugLineNum = 160;BA.debugLine="Sub Handler_InterstitialLoaded()";
 //BA.debugLineNum = 161;BA.debugLine="Log(\"interstitial loaded\")";
...
public static String  _handler_interstitialshown() throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Sub Handler_InterstitialShown()";
 //BA.debugLineNum = 169;BA.debugLine="Log(\"interstitial shown\")";
...
public static String  _handler_nonskippablefailedtoload() throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub Handler_NonSkippableFailedToLoad()";
 //BA.debugLineNum = 225;BA.debugLine="Log(\"non skippable video failed to load\")";
...
public static String  _handler_nonskippablevideoclosed() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub Handler_NonSkippableVideoClosed()";
 //BA.debugLineNum = 233;BA.debugLine="Log(\"non skippable video closed\")";
...
public static String  _handler_nonskippablevideofinished() throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub Handler_NonSkippableVideoFinished()";
 //BA.debugLineNum = 237;BA.debugLine="Log(\"non skippable video shown\")";
...
public static String  _handler_nonskippablevideoloaded() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub Handler_NonSkippableVideoLoaded()";
 //BA.debugLineNum = 221;BA.debugLine="Log(\"non skippable video loaded\")";
...
public static String  _handler_nonskippablevideoshown() throws Exception{
 //BA.debugLineNum = 228;BA.debugLine="Sub Handler_NonSkippableVideoShown()";
 //BA.debugLineNum = 229;BA.debugLine="Log(\"non skippable video shown\")";
anywheresoftware.b4a.keywords.Common.Log("non skippable video shown");
 //BA.debugLineNum = 230;BA.debugLine="End Sub";
return "";
}
public static String  _handler_rewardedvideoclosed() throws Exception{
 //BA.debugLineNum = 210;BA.debugLine="Sub Handler_RewardedVideoClosed()";
 //BA.debugLineNum = 211;BA.debugLine="Log(\"rewarded video closed\")";
...
public static String  _handler_rewardedvideofailedtoload() throws Exception{
 //BA.debugLineNum = 202;BA.debugLine="Sub Handler_RewardedVideoFailedToLoad()";
 //BA.debugLineNum = 203;BA.debugLine="Log(\"rewarded video failed to load\")";
...
public static String  _handler_rewardedvideofinished(int _amount,String _name) throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Sub Handler_RewardedVideoFinished(amount As Int, n";
 //BA.debugLineNum = 216;BA.debugLine="Log(\"rewarded video shown\" & amount & \" \" & name)";
...
public static String  _handler_rewardedvideoloaded() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub Handler_RewardedVideoLoaded()";
 //BA.debugLineNum = 199;BA.debugLine="Log(\"rewarded video loaded\")";
...
public static String  _handler_rewardedvideoshown() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub Handler_RewardedVideoShown()";
 //BA.debugLineNum = 207;BA.debugLine="Log(\"rewarded video shown\")";
...
public static String  _handler_skippablefailedtoload() throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Sub Handler_SkippableFailedToLoad()";
 //BA.debugLineNum = 247;BA.debugLine="Log(\"skippable video failed to load\")";
...
public static String  _handler_skippablevideoclosed() throws Exception{
 //BA.debugLineNum = 254;BA.debugLine="Sub Handler_SkippableVideoClosed()";
 //BA.debugLineNum = 255;BA.debugLine="Log(\"skippable video closed\")";
...
public static String  _handler_skippablevideofinished() throws Exception{
 //BA.debugLineNum = 258;BA.debugLine="Sub Handler_SkippableVideoFinished()";
 //BA.debugLineNum = 259;BA.debugLine="Log(\"skippable video shown\")";
...
public static String  _handler_skippablevideoloaded() throws Exception{
 //BA.debugLineNum = 241;BA.debugLine="Sub Handler_SkippableVideoLoaded()";
 //BA.debugLineNum = 242;BA.debugLine="Log(\"skippable video loaded\")";
...
public static String  _handler_skippablevideoshown() throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub Handler_SkippableVideoShown()";
 //BA.debugLineNum = 251;BA.debugLine="Log(\"skippable video shown\")";
anywheresoftware.b4a.keywords.Common.Log("skippable video shown");
 //BA.debugLineNum = 252;BA.debugLine="End Sub";
return "";
}
public static String  _hidebanner_click() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub hideBanner_Click";
 //BA.debugLineNum = 156;BA.debugLine="Appodeal.hide(Appodeal.BANNER)";
...
public static String  _init_click() throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Sub init_Click";
 //BA.debugLineNum = 102;BA.debugLine="Appodeal.setEventHandler(\"Handler\")";
mostCurrent._appodeal.setEventHandler(mostCurrent.activityBA,"Handler");
 //BA.debugLineNum = 103;BA.debugLine="Appodeal.setRewardedVideoCallbacks()";
mostCurrent._appodeal.setRewardedVideoCallbacks(mostCurrent.activityBA);
 //BA.debugLineNum = 104;BA.debugLine="Appodeal.setBannerCallbacks()";
mostCurrent._appodeal.setBannerCallbacks(mostCurrent.activityBA);
 //BA.debugLineNum = 105;BA.debugLine="Appodeal.setSkippableVideoCallbacks()";
mostCurrent._appodeal.setSkippableVideoCallbacks(mostCurrent.activityBA);
 //BA.debugLineNum = 106;BA.debugLine="Appodeal.setInterstitialCallbacks()";
mostCurrent._appodeal.setInterstitialCallbacks(mostCurrent.activityBA);
 //BA.debugLineNum = 108;BA.debugLine="If(checkConfirm.Checked) Then";
if ((mostCurrent._checkconfirm.getChecked())) { 
 //BA.debugLineNum = 109;BA.debugLine="Appodeal.confirm(Appodeal.SKIPPABLE_VIDEO)";
mostCurrent._appodeal.confirm(mostCurrent._appodeal.SKIPPABLE_VIDEO);
 };
 //BA.debugLineNum = 111;BA.debugLine="If(checkTesting.Checked) Then";
if ((mostCurrent._checktesting.getChecked())) { 
 //BA.debugLineNum = 112;BA.debugLine="Appodeal.setTesting(True)";
mostCurrent._appodeal.setTesting(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 114;BA.debugLine="If(checkLogging.Checked) Then";
if ((mostCurrent._checklogging.getChecked())) { 
 //BA.debugLineNum = 115;BA.debugLine="Appodeal.setLogging(True)";
mostCurrent._appodeal.setLogging(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 117;BA.debugLine="Appodeal.disableWriteExternalStoragePermissionChe";
mostCurrent._appodeal.disableWriteExternalStoragePermissionCheck();
 //BA.debugLineNum = 118;BA.debugLine="Appodeal.disableLocationPermissionCheck()";
mostCurrent._appodeal.disableLocationPermissionCheck();
 //BA.debugLineNum = 119;BA.debugLine="Appodeal.confirm(Appodeal.SKIPPABLE_VIDEO)";
mostCurrent._appodeal.confirm(mostCurrent._appodeal.SKIPPABLE_VIDEO);
 //BA.debugLineNum = 120;BA.debugLine="Appodeal.initialize(appKey, Bit.Or(Appodeal.REWAR";
mostCurrent._appodeal.initialize(mostCurrent.activityBA,mostCurrent._appkey,anywheresoftware.b4a.keywords.Common.Bit.Or(mostCurrent._appodeal.REWARDED_VIDEO,mostCurrent._appodeal.SKIPPABLE_VIDEO));
 //BA.debugLineNum = 121;BA.debugLine="Appodeal.initialize(appKey, Bit.Or(Appodeal.INTER";
...
public static String  _rewardedvideo_click() throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Sub rewardedVideo_Click";
 //BA.debugLineNum = 142;BA.debugLine="If(Appodeal.isLoaded(Appodeal.REWARDED_VIDEO)) Th";
if ((mostCurrent._appodeal.isLoaded(mostCurrent.activityBA,mostCurrent._appodeal.REWARDED_VIDEO))) { 
 //BA.debugLineNum = 143;BA.debugLine="Appodeal.show(Appodeal.REWARDED_VIDEO)";
...
public static String  _showbanner_click() throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Sub showBanner_Click";
 //BA.debugLineNum = 152;BA.debugLine="Appodeal.show(Appodeal.BANNER_BOTTOM)";
...
public static String  _showinterstitial_click() throws Exception{
 //BA.debugLineNum = 130;BA.debugLine="Sub showInterstitial_Click";
 //BA.debugLineNum = 131;BA.debugLine="Appodeal.showWithPlacement(Appodeal.INTERSTITIAL,";
mostCurrent._appodeal.showWithPlacement(mostCurrent.activityBA,mostCurrent._appodeal.INTERSTITIAL,"level_end");
 //BA.debugLineNum = 132;BA.debugLine="Appodeal.setCustomBooleanSegment(\"level_end\", Tru";
mostCurrent._appodeal.setCustomBooleanSegment("level_end",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 133;BA.debugLine="End Sub";
return "";
}
public static String  _showvideo_click() throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Sub showVideo_Click";
 //BA.debugLineNum = 136;BA.debugLine="If(Appodeal.isLoaded(Appodeal.SKIPPABLE_VIDEO)) T";
if ((mostCurrent._appodeal.isLoaded(mostCurrent.activityBA,mostCurrent._appodeal.SKIPPABLE_VIDEO))) { 
 //BA.debugLineNum = 137;BA.debugLine="Appodeal.show(Appodeal.SKIPPABLE_VIDEO)";
...
public static String  _showvideoorinterstitial_click() throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub showVideoOrInterstitial_Click";
 //BA.debugLineNum = 148;BA.debugLine="Appodeal.show(Bit.Or(Appodeal.INTERSTITIAL, Appod";
